...
<button class="nav" onclick={() => (open = !open)}>
	...
	{#if open}
		<svg
			...
			transition:wide={{}}
		>
			<path d="M1 11L11 0.999999" stroke="white" stroke-width="2" stroke-linecap="round" />
			<path d="M1.00781 1L11.0078 11" stroke="white" stroke-width="2" stroke-linecap="round" />
		</svg>
	{:else}
		<svg width="15" height="15" class="stroke-main-white stroke-2" transition:wide={{}}>
			<line x1="10%" x2="90%" y1="10%" y2="10%" stroke-linecap="round" />
			<line x1="10%" x2="90%" y1="50%" y2="50%" stroke-linecap="round" />
			<line x1="10%" x2="90%" y1="90%" y2="90%" stroke-linecap="round" />
		</svg>
	{/if}
</button>
...
<style>
	...
	.menu {
		@apply relative rounded-md border-2 border-main-orange p-5;
	}
	.menu::before {
		content: ' ';
		position: absolute;
