...
{#if open}
	<div class="menu-holder" onclick={() => (open = false)} transition:whoosh={{}}>
		<div class="menu">
			...
			<!-- <div class=""> -->
			<!-- 	<a href="mailto:alexanderlutz@yahoo.com">email</a> -->
			<!-- 	<a href="https://www.linkedin.com/in/alex-lutz-1o/">LinkedIn</a> -->
			<!-- 	<a href="https://github.com/aldottexe">Github</a> -->
			<!-- </div> -->
			<!-- <hr class="my-2 border-1" /> -->
